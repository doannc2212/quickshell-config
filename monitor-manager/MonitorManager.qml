...
Scope {
    ...
    function applyChanges() {
        ...
        statusText = "Applying monitor layout...";
    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            height: Math.min(parent.height - 56, 820)
            radius: 22
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    text: "ARandR-style layout editor for Hyprland outputs."
                            ...
                            ColumnLayout {
                                ...
                                GridLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        height: 34
                                        radius: 10
                                        color: upMouse.containsMouse ? root.theme.bgHover : root.theme.bgSurface
                                        border.color: root.theme.bgBorder
                                        border.width: 1
                                        ...
                                        MouseArea {
                                            ...
                                            hoverEnabled: true
                                            cursorShape: Qt.PointingHandCursor
                                            onClicked: root.moveSelected(0, -10)
                                        }
                                    ...
                                    Rectangle {
                                        ...
                                        height: 34
                                        radius: 10
                                        color: leftMouse.containsMouse ? root.theme.bgHover : root.theme.bgSurface
                                        border.color: root.theme.bgBorder
                                        border.width: 1
                                        ...
                                        MouseArea {
                                            ...
                                            hoverEnabled: true
                                            cursorShape: Qt.PointingHandCursor
                                            onClicked: root.moveSelected(-10, 0)
                                        }
                                    ...
                                    Rectangle {
                                        ...
                                        height: 34
                                        radius: 10
                                        color: downMouse.containsMouse ? root.theme.bgHover : root.theme.bgSurface
                                        border.color: root.theme.bgBorder
                                        border.width: 1
                                    ...
                                    Rectangle {
                                        ...
                                        height: 34
                                        radius: 10
                                        color: rightMouse.containsMouse ? root.theme.bgHover : root.theme.bgSurface
                                        border.color: root.theme.bgBorder
                                        border.width: 1
